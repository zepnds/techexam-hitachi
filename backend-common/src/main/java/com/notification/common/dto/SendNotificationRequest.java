...
public class SendNotificationRequest {
    ...
    @Schema(description = "Notification message text payload", example = "Your OTP is 9876")
    ...
    @Schema(description = "Optional client idempotency key to prevent duplicate delivery on network retries", example = "idemp-992a-4b10")
